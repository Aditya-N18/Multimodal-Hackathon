/** EvidenceLine — Nebius vision prompts (from Person C's nebius/prompts.py) */

export const SYSTEM_PROMPT = `You are an incident evidence analyst. You will receive one photo related to an
...
export function buildUserMessage(incidentType, rawTranscript, location) {
  return `Incident type reported: ${incidentType}
